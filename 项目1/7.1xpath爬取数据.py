...
# 提交图片url请求
response = requests.get("http://www.gandianli.com/sell/",headers=headers_base)
html = etree.HTML(response.text)
text_info = html.xpath("//div[@class='navigation_nav']/ul/li/a/text() | \
                       //div[@class = 'navigation_nav']/ul/li[position()>1]/a/@href")

for ele in text_info:
    print(ele)
    print(type(ele))  # <class 'lxml.etree._ElementUnicodeResult'>
